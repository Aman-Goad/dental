...
const Work = () => {
  ...
  return (
    <div className='w-full min-h-screen bg-zinc-100 mt-20 mb-6'>
      <div className='max-w-screen-lg mx-auto'>
        <div className='heading text-center font-bold text-[3vw] pt-20 tracking-tight leading-tight'>
          ...
          <p className='text-zinc-500 text-[1.3vw] mt-4 font-thin italic w-2/3 text-center mx-auto'>
        ...
        <div className='mt-16 w-full flex justify-center items-center flex-col gap-4 pb-8 overflow-hidden'>
          {work.map((item, index) => {
            ...
            return (
              ...
              >
                <div className='image w-[20%] h-full flex items-start justify-center pt-2'>
                  <div className='h-[6vw] w-[6vw] bg-black group-hover:bg-textwhite rounded-full flex items-center justify-center duration-300'>
                    {IconComponent && (
                      <IconComponent
                        size={40}
                ...
                <div className='text w-[80%] h-full'>
                  <h1 className='text-[2vw] font-bold'>{item.title}</h1>
                  <p className='text-[1.1vw] mt-2'>{item.description}</p>
                </div>
              </motion.div>
            );
          })}
