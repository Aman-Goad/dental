  ...
  {/* form section */}
      <div className="w-full md:w-1/2 lg:w-2/5 bg-white p-8 shadow-md rounded-lg">
        ...
        <form>
          ...
          <div className="mb-4">
            <label htmlFor="service" className="block text-gray-700 font-bold mb-2">Job title</label>
            <select id="service" className="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
              <option value="">Select a title</option>
              <option value="consultation">Quality Check</option>
              <option value="cleaning">Designer</option>
            </select>
          </div>

          <div className="mb-4">
            <label htmlFor="service" className="block text-gray-700 font-bold mb-2">Experience</label>
            <select id="service" className="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
              <option value="">Select experience</option>
              <option value="consultation">less than 1 year</option>
              <option value="cleaning">1-2 Years</option>
              <option value="cleaning">2-4 Years</option>
              <option value="cleaning">5+ Years</option>
            </select>
          </div>
